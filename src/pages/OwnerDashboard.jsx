      ...
      <div className="dashboard">
        <div className="sidebar">
          ...
          <div className="sidebar-section">
            ...
            {/* ✅ NUEVO: Perfil del propietario */}
            <div className={`sidebar-item ${activeTab === 'perfil' ? 'active' : ''}`} onClick={() => setActiveTab('perfil')}><i className="fas fa-user"></i> Mi perfil</div>
        ...
        <div className="content">
                ...
                <div className="chat-window">
                  ...
                  <div className="chat-messages">
                    {mensajes.length === 0 ? (
                      ...
                      mensajes.map(msg => (
                        // ✅ FIX: cada mensaje en su propio contenedor flex para que sent/received funcione
          ...
          {activeTab === 'perfil' && (
            <div className="page active">
              <div className="page-header"><h1>Mi Perfil</h1><p>Información del propietario.</p></div>
              <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '14px', padding: '2rem', maxWidth: '540px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1.2rem', marginBottom: '2rem' }}>
                  <div className="avatar-owner" style={{ width: '64px', height: '64px', fontSize: '1.6rem', fontWeight: '700', backgroundColor: avatarColor }}>
                    {iniciales}
                  </div>
                  <div>
                    <div style={{ fontFamily: "'Syne', sans-serif", fontSize: '1.2rem', fontWeight: '700' }}>{usuario.nombre || 'Admin'}</div>
                    <div style={{ color: 'var(--muted)', fontSize: '0.85rem' }}>Propietario del sistema</div>
                  </div>
                </div>
                <div style={{ display: 'grid', gap: '1rem' }}>
                  ...
                  <div><div style={{ fontSize: '0.75rem', color: 'var(--muted)', fontWeight: '600', textTransform: 'uppercase', marginBottom: '0.3rem' }}>Rol</div><div>Propietario</div></div>
                </div>
              </div>
            </div>
          )}

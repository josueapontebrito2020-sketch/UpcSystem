...
const Home = () => {
  ...
  // Llama a 3 endpoints en paralelo para cargar servicios, técnicos y accesorios
  // ─────────────────────────────────────────────────────────────
  useEffect(() => {
  ...
  // ─────────────────────────────────────────────────────────────
  // FILTRO DE ACCESORIOS POR CATEGORÍA
  // No llama a la API, filtra directamente el estado local
  // Se recalcula automáticamente cada vez que cambia categoriaActiva
  // ─────────────────────────────────────────────────────────────
  ...
  // ─────────────────────────────────────────────────────────────
  // ANIMACIONES FADE-IN
  // Detecta cuando los elementos entran en pantalla y les agrega la clase 'visible'
  // Se re-ejecuta cada vez que cambia la categoría para re-observar los nuevos elementos
  // ─────────────────────────────────────────────────────────────
  useEffect(() => {
    ...
    return () => fadeObserver.disconnect(); // Limpia el observer al cambiar categoría
  }, [categoriaActiva]); // Se re-ejecuta cada vez que cambia la categoría
